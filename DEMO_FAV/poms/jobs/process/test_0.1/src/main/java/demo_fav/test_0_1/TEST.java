...
public class TEST implements TalendJob {
	...
	private final String projectName = "DEMO_FAV";
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_DEMO_FAV_TEST = new byte[0];
		static byte[] commonByteArray_DEMO_FAV_TEST = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DEMO_FAV_TEST.length) {
					if (length < 1024 && commonByteArray_DEMO_FAV_TEST.length == 0) {
						commonByteArray_DEMO_FAV_TEST = new byte[1024];
					} else {
						commonByteArray_DEMO_FAV_TEST = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DEMO_FAV_TEST, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAV_TEST, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DEMO_FAV_TEST, 0, length);
				strReturn = new String(commonByteArray_DEMO_FAV_TEST, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DEMO_FAV_TEST) {
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "Pl68U3_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "hdqcnl_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_tDyNsCcjEe6zg4Lw5rsuSA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-07-20T21:00:59.447043600Z");
		...
		try {
			...
			java.io.InputStream inContext = TEST.class.getClassLoader()
					.getResourceAsStream("demo_fav/test_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 58950 characters generated by Talend Cloud Data Fabric on the 20 de julio de
 * 2023, 16:00:59 COT
 ************************************************************************************************/